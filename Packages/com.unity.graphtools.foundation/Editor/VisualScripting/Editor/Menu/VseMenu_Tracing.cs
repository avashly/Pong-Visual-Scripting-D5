...
namespace UnityEditor.VisualScripting.Editor
{
    partial class VseMenu
    {
        ...
        {
            public readonly DebuggerTracer.FrameData.EntityReference Entity;
            public EntitySearcherItem(DebuggerTracer.FrameData.EntityReference entityReference) : base($"{entityReference.EntityIndex}")
            {
